...
///
class FxEnsureVisibleWhenFocused extends StatefulWidget {
  const FxEnsureVisibleWhenFocused({
    Key? key,
    required this.child,
  ...
  @override
  _FxEnsureVisibleWhenFocusedState createState() =>
      _FxEnsureVisibleWhenFocusedState();
}

///
/// We implement the WidgetsBindingObserver to be notified of any change to the window metrics
///
class _FxEnsureVisibleWhenFocusedState extends State<FxEnsureVisibleWhenFocused>
