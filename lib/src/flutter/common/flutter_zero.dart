...
class FxZeroCard extends StatefulWidget {
  const FxZeroCard(
  ...
  @override
  _FxZeroCardState createState() => _FxZeroCardState();
}

class _FxZeroCardState extends State<FxZeroCard>
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: <Widget>[
                          _FxLine(20, 0.8, animation, widget.isDark),
                          _FxLine(15, 0.7, animation, widget.isDark),
                        ],
                      ),
                    ),
                    const Spacer(),
                    Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          _FxLine(15, 0.8, animation, widget.isDark),
                          _FxLine(15, 0.7, animation, widget.isDark),
                        ],
                      ),
                    ),
                ...
                if (widget.isBottomLinesActive)
                  Column(
                    ...
                    children: <Widget>[
                      ...
                      _FxLine(70, 0.7, animation, widget.isDark),
                      const SizedBox(
                        height: 10,
                      ),
                      _FxLine(80, 0.7, animation, widget.isDark),
                      const SizedBox(
                        height: 10,
                      ),
                      _FxLine(50, 0.7, animation, widget.isDark),
                    ],
                  )
                else
                  const Offstage()
...
class FxZeroList extends StatelessWidget {
  const FxZeroList(
      {Key? key,
      this.isCircularImage = true,
      this.length = 10,
