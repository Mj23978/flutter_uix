...
class MaterialResponsiveUiData {
  ...
  MobileWindowSize get windowSize {
    if (_width < 350.0) {
      return MobileWindowSize.watch;
    }
    
    if (_width < 600.0) {
      return MobileWindowSize.mobile;
    }

    if (_width < 1024.0) {
      return MobileWindowSize.tablet;
    }
    if (_width < 1440.0) {
      return MobileWindowSize.web;
    }

    if (_width < 1920.0) {
      return MobileWindowSize.desktop;
    }

    return MobileWindowSize.tv;
  }
...
enum MobileWindowSize { watch, mobile, tablet, web, desktop, tv }
